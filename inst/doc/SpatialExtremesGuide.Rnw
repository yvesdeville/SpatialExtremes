...
par(mfrow=c(1,2))
image(x, x, log(data0), col = terrain.colors(40))
image(x, x, log(data1), col = terrain.colors(40))
@
...
par(mfrow=c(1,3))
image(x, y, data1, col = terrain.colors(30))
image(x, y, data2, col = terrain.colors(30))
image(x, y, data3, col = terrain.colors(30))
@
...
par(mfrow = c(1,2))
image(x, y, log(M0), col = terrain.colors(30))
image(x, y, log(M1), col = terrain.colors(30))
@
